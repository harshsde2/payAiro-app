...
auto module_rnplaidlink = rnplaidlink_ModuleProvider(moduleName, params);
if (module_rnplaidlink != nullptr) {
return module_rnplaidlink;
}
...
providerRegistry->add(concreteComponentDescriptorProvider<PLKEmbeddedViewComponentDescriptor>());
