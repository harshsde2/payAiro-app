 ...
 * Mock Data Constants
 * 
 * This file contains mock/example data used throughout the application.
 ...
 * Uses environment configuration for consistency
 * 
 * @deprecated This export is kept for backward compatibility.
 * Consider using getApiBaseUrl() from config/env.config.ts directly.
 */
