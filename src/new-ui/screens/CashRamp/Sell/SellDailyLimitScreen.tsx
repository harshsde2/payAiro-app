...
import { SELL_DAILY_LIMIT_BODY, SELL_DAILY_LIMIT_TITLE } from "./sellFlowCopy";

const SellDailyLimitScreen: React.FC = () => {
...
export default SellDailyLimitScreen;
