...
function normalizeReceiveSymbol(symbol: string): string {
...
function symbolMatchCandidates(normalized: string): Set<string> {
...
function findWalletRowForSymbol(
