...
import { forgotPasswordVerificationStyles } from '@styles/screens/auth/forgotPasswordVerificationStyles';
import CustomText from '@components/common-components/CustomText';

type ForgotPasswordVerificationScreenNavigationProp = NativeStackNavigationProp<
  AuthStackParamList,
  typeof NAVIGATION_SCREENS.FORGOT_PASSWORD_VERIFICATION
>;

type ForgotPasswordVerificationScreenRouteProp = RouteProp<
  AuthStackParamList,
  typeof NAVIGATION_SCREENS.FORGOT_PASSWORD_VERIFICATION
>;
