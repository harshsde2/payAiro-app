...
const TrustedCircle = () => {
  ...
  const { isCrypto, tokens } = useSelector(
  ...
  const handleNavigation = (ScreenName: string) => {
    switch (ScreenName) {
      case NAVIGATION_SCREENS.CONTACT_SCREEN: {
        (navigation as any).navigate(NAVIGATION_SCREENS.CONTACT_SCREEN, {
          isVisible3: true,
        });
        break;
      }
    ...
    <ScreenContainer padding={0} backgroundColor={theme.colors.palette.green50}>
      ...
      >
        ...
        <SvgXml
          ...
          height={50}
          style={{ marginLeft: 10 }}
          onPress={() => handleNavigation(NAVIGATION_SCREENS.CONTACT_SCREEN)}
          xml={SVGAddIcon}
        />
      </View>
