...
const PendingRequest: FC<PendingRequestProps> = ({
  ...
  let userName = isFromUser
    ? contact && (contact as ContactData).nickname
      ? (contact as ContactData).nickname
      : ""
    : "you";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <SvgXml xml={SVGRequested} width={17} height={17} />
          <CustomText
            variant={"body2"}
            color={theme.colors.palette.orange500}
            style={{ flex: 1, paddingLeft: 5, marginTop: 3 }}
          >{`Requested`}</CustomText>
        </View>
